...
set psu_clock_init_data {
    ...
    mask_write 0XFF5E00C8 0x013F3F07 0x01010A00
    ...
    mask_write 0XFF5E00CC 0x013F3F07 0x01010600
		# Register : AMS_REF_CTRL @ 0XFF5E0108</p>
...
set psu_mio_init_data {
    ...
    mask_write 0XFF180208 0xFFFFFFFF 0x00B0303F
    ...
    mask_write 0XFF180140 0x03FFFFFF 0x03F7EE5E
    ...
    mask_write 0XFF18014C 0x03FFFFFF 0x03FBFE7D
    ...
    mask_write 0XFF18015C 0x03FFFFFF 0x01FFFFC0
    ...
    mask_write 0XFF180168 0x03FFFFFF 0x03F3F02B
    ...
    mask_write 0XFF180178 0x03FFFFFF 0x02000000
    ...
    mask_write 0XFF180184 0x03FFFFFF 0x03000000
		# : LOOPBACK
...
set psu_peripherals_init_data {
    ...
    mask_write 0XFF0A0204 0x03FFFFFF 0x00000100
		# : DIR MODE BANK 1
		# : DIR MODE BANK 2
    ...
    mask_write 0XFF0A0208 0x03FFFFFF 0x00000100
		# : OUTPUT ENABLE BANK 1
		# : OUTPUT ENABLE BANK 2
		# : MASK_DATA_0_LSW LOW BANK [15:0]
		# Register : MASK_DATA_0_LSW @ 0XFF0A0000</p>
    ...
    mask_write 0XFF0A0000 0xFFFFFFFF 0xFEFF0100
    ...
    mask_write 0XFF0A0000 0xFFFFFFFF 0xFEFF0000
		# : MASK_DATA_0_MSW LOW BANK [25:16]
		# : MASK_DATA_1_LSW LOW BANK [41:26]
		# : MASK_DATA_1_MSW HIGH BANK [51:42]
		# : MASK_DATA_1_LSW HIGH BANK [67:52]
