...
/*##################################################################### */
    ...
    * 6 bit divider
    *  PSU_CRL_APB_PL2_REF_CTRL_DIVISOR0                           0xa
    ...
    * This register controls this reference clock
    * (OFFSET, MASK, VALUE)      (0XFF5E00C8, 0x013F3F07U ,0x01010A00U)
    */
...
/*##################################################################### */
    ...
    * 6 bit divider
    *  PSU_CRL_APB_PL3_REF_CTRL_DIVISOR0                           0x6
    ...
    * This register controls this reference clock
    * (OFFSET, MASK, VALUE)      (0XFF5E00CC, 0x013F3F07U ,0x01010600U)
    */
...
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_4_OFFSET, 0x000000FEU, 0x00000000U);
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_5_OFFSET, 0x000000FEU, 0x00000000U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180208, 0xFFFFFFFFU ,0x00B0303FU)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_MST_TRI1_OFFSET,
		0xFFFFFFFFU, 0x00B0303FU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180140, 0x03FFFFFFU ,0x03F7EE5EU)
    */
	PSU_Mask_Write(IOU_SLCR_BANK0_CTRL3_OFFSET,
		0x03FFFFFFU, 0x03F7EE5EU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF18014C, 0x03FFFFFFU ,0x03FBFE7DU)
    */
	PSU_Mask_Write(IOU_SLCR_BANK0_CTRL6_OFFSET,
		0x03FFFFFFU, 0x03FBFE7DU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF18015C, 0x03FFFFFFU ,0x01FFFFC0U)
    */
	PSU_Mask_Write(IOU_SLCR_BANK1_CTRL3_OFFSET,
		0x03FFFFFFU, 0x01FFFFC0U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180168, 0x03FFFFFFU ,0x03F3F02BU)
    */
	PSU_Mask_Write(IOU_SLCR_BANK1_CTRL6_OFFSET,
		0x03FFFFFFU, 0x03F3F02BU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180178, 0x03FFFFFFU ,0x02000000U)
    */
	PSU_Mask_Write(IOU_SLCR_BANK2_CTRL3_OFFSET,
		0x03FFFFFFU, 0x02000000U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180184, 0x03FFFFFFU ,0x03000000U)
    */
	PSU_Mask_Write(IOU_SLCR_BANK2_CTRL6_OFFSET,
		0x03FFFFFFU, 0x03000000U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_GPIO_DIRM_0_DIRECTION_0                                 0x100

    * Direction mode (GPIO Bank0, MIO)
    * (OFFSET, MASK, VALUE)      (0XFF0A0204, 0x03FFFFFFU ,0x00000100U)
    */
	PSU_Mask_Write(GPIO_DIRM_0_OFFSET, 0x03FFFFFFU, 0x00000100U);
/*##################################################################### */
    ...
    *  PSU_GPIO_OEN_0_OP_ENABLE_0                                  0x100

    * Output enable (GPIO Bank0, MIO)
    * (OFFSET, MASK, VALUE)      (0XFF0A0208, 0x03FFFFFFU ,0x00000100U)
    */
	PSU_Mask_Write(GPIO_OEN_0_OFFSET, 0x03FFFFFFU, 0x00000100U);
/*##################################################################### */
    ...
    */
    /*
    * Register : MASK_DATA_0_LSW @ 0XFF0A0000
    ...
    *  PSU_GPIO_MASK_DATA_0_LSW_MASK_0_LSW                         0xfeff
    ...
    *  PSU_GPIO_MASK_DATA_0_LSW_DATA_0_LSW                         0x100

    * Maskable Output Data (GPIO Bank0, MIO, Lower 16bits)
    * (OFFSET, MASK, VALUE)      (0XFF0A0000, 0xFFFFFFFFU ,0xFEFF0100U)
    */
	PSU_Mask_Write(GPIO_MASK_DATA_0_LSW_OFFSET,
		0xFFFFFFFFU, 0xFEFF0100U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * k. Reads return the previous value written to this register or DATA_0[15
    * :0]. Reads do not return the value on the GPIO pin.
    *  PSU_GPIO_MASK_DATA_0_LSW_DATA_0_LSW                         0x0

    * Maskable Output Data (GPIO Bank0, MIO, Lower 16bits)
    * (OFFSET, MASK, VALUE)      (0XFF0A0000, 0xFFFFFFFFU ,0xFEFF0000U)
    */
	PSU_Mask_Write(GPIO_MASK_DATA_0_LSW_OFFSET,
		0xFFFFFFFFU, 0xFEFF0000U);
/*##################################################################### */
