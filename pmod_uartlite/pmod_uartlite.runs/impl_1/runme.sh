...
HD_PWD='/home/jing/RFSoC2x2-PYNQ/board/RFSoC2x2/base/project/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uartlite_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uartlite_wrapper.tcl -notrace
