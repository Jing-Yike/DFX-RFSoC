...
HD_PWD='/home/jing/RFSoC2x2-PYNQ/board/RFSoC2x2/base/project/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uartlite_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uartlite_wrapper.tcl
